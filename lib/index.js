...
function decodeUTF8(string) {
  var i;
  var d = unescape(encodeURIComponent(string));
...
var E2E = /*#__PURE__*/function () {
  ...
  _createClass(E2E, [{
    ...
    value: function Encrypt(plainText, receiverPubKey, options) {
      ...
      var nonce = newNonceS();
      var keyUint8Array = decodeBase64(symmetricKey.raw);

      if (_typeof(plainText) !== 'object') {
        throw new Error('Only JSON object accepted as an input');
      }

      var messageUint8 = decodeUTF8(JSON.stringify(plainText));
      ...
      var fullMessageAsBase64 = encodeBase64(fullMessage);
    ...
    value: function Decrypt(cipherText, senderPublicKey, options) {
      ...
      var keyUint8Array = decodeBase64(symmetricKey);
      var messageWithNonceAsUint8Array = decodeBase64(dataParts[0]);
    ...
    value: function EncryptSymmetricKey(publicKey) {
      var symmetricKey = encodeBase64((0, _tweetnacl.randomBytes)(_tweetnacl.secretbox.keyLength));
      var nonce = newNonceA();
      var finalKey = this.GetShared(publicKey);
      var pubKeyAsUint8Array = decodeBase64(finalKey);
      var messageUint8 = decodeUTF8(JSON.stringify({
        key: symmetricKey
      }));
    ...
    value: function DecryptSymmetricKey(messageWithNonce, publicKey) {
      var finalKey = this.GetShared(publicKey);
      var privateKeyAsUint8Array = decodeBase64(finalKey);
      ...
      var jsonObject = JSON.parse(encodeUTF8(decrypted));
    ...
    value: function GetShared(publicKey) {
      var publicKeyAsUint8Array = decodeBase64(publicKey);
      var privateKeyAsUint8Array = decodeBase64(this.privateKey);
